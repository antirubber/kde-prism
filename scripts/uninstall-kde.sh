...
rm -f  "${KONSOLE_DEST}"
rm -f  "${PREFIX}/.local/share/konsole/${COLORSCHEME_NAME}.profile"
...
rm -f  "${PREFIX}/.config/alacritty/themes/kde-prism.toml"
rm -rf "${PREFIX}/.config/kitty/themes/kde-prism.conf"
rm -f  "${PREFIX}/.local/share/katecolor-schemes/kde-prism.xml"
...
echo "  ${PREFIX}/.config/alacritty/themes/kde-prism.toml"
echo "  ${PREFIX}/.config/kitty/themes/kde-prism.conf"
echo "  ${PREFIX}/.local/share/katecolor-schemes/kde-prism.xml"
echo ""
